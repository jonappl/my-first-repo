...
const philosophyText1 = `hi, im jonathan. im a  student at mater dei high school and im learning web design. this year ive built games, tools, and interactive projects using html, css, and javascript.`;

const philosophyText2 = `im interested in mcdonalds. outside of coding i eat. these projects show what ive learned so far.`;
